...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form action="/index.php/admin/utilisateur/gererUtilisateur/<?php echo (isset($data)) ? $data["id_utilisateur"].'/modifier' : 'ajouter' ;?>" method="post">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="id_utilisateur" value="<?php echo (isset($data)) ? $data["id_utilisateur"] : '' ;?>">
                            <input type="text" name="nom_utilisateur" id="inputName" class="form-control" value="<?php echo (isset($data)) ? $data["nom_utilisateur"] : '' ;?>">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="password" name="mdp" id="inputName" class="form-control <?php echo (isset($data['err'])) ? $data["err"] : '' ;?>">
                        </div>
                        <div class="form-group">
                            <label for="inputDescription">Confirmer le mot de passe</label>
                            <input type="password" name="conf_mdp" id="inputName" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
