            ...
            if (is_numeric($param[1])) {
                ...
                if (isset($param[2])) {
                    ...
                    if ($param[2]=='supprimer') {
                        ...
                        if ($response) {
                            header('Location:/index.php/admin/categorie/listUtilisateur');
                        }
                        ...
                        if (isset($_POST['mod'])) {
                            ...
                            if ($response) {
                                header('Location:/index.php/admin/categorie/gererCategorie/'.$_POST['id_cat']);
                            }
                        }
                    ...
                    Path::getAdminViews("nvcategorie",$cat);
                }
