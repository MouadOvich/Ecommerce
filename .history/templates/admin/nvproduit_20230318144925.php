...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form action="/index.php/admin/produit/gererProduit/<?php echo (isset($data)) ? 'modifier' : 'ajouter' ;?>" method="post"></form>
                ...
                <div class="card card-outline card-info">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="inputName" name="nom" class="form-control" value="<?php echo (isset($data)) ? $data["nom"] : '' ;?>">
                        </div>
                        <div class="row">
                        <div class="form-group col-6">
                            <label for="inputDescription">SKU</label>
                            <input type="text" id="inputName" name="sku" class="form-control" value="<?php echo (isset($data)) ? $data["sku"] : '' ;?>">
                        </div>
                        <div class="form-group col-6">
                            <label for="inputDescription">Quantité</label>
                            <input type="number" id="inputName" name="qte" class="form-control" value="<?php echo (isset($data)) ? $data["qte"] : '' ;?>">
                        </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="form-group col 6">
                                ...
                                <input type="text" id="inputName" name="prix" class="form-control" value="<?php echo (isset($data)) ? $data["prix"] : '' ;?>">
                            </div>
                            <div class="form-group col-6">
                                <label for="inputName">Comparé au prix</label>
                                <input type="text" id="inputName" name="comp_prix" class="form-control" value="<?php echo (isset($data)) ? $data["comp_prix"] : '' ;?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="exampleInputFile" name="cat">
