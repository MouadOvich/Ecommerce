            ...
            if (is_numeric($param[1])) {
                ...
                if (isset($param[2])) {
                    ...
                    if ($param[2]=='supprimer') {
                        $img=$pc->getImgName($param[1]);
                        unlink(./assets/img/produit/"test.txt");
                        print_r($img);
                        //$response=$pc->deleteProd($param[1]);
                        ...
                        if (isset($_POST['mod'])) {
                            ...
                            if ($response) {
                                ...
                                header('Location:/index.php/admin/produit/gererProduit/'.$_POST['id_prod']);
                            }
                        }
