              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th>
                      <div class="user-block"><img class="img-xs" src="../../../../assets/img/produit/<?php echo $product['image1'] ?>"></div>
                      </th>
                      <td style="text-align:left;">
                        <div class="user-block">
                          <div class="">
                            <a href="/index.php/admin/produit/gererProduit/<?php echo $product['id_prod'] ?>" class="float-left"><?php echo $product['nom'] ?></a>
                      ...
                      <td class="float-right">
                        ...
                        <div class="dropdown-menu">
                          <a class="dropdown-item" tabindex="-1" href="/index.php/admin/produit/gererProduit/<?php echo $product['id_prod'] ?>">Modifier</a>
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item text-danger" tabindex="-1" href="/index.php/admin/produit/gererProduit/<?php echo $product['id_prod'] ?>/supprimer">Supprimer</a>
                        </div>
                      </td>
                    </tr>
                  <?php } ?>
