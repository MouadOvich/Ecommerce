            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <th>
                    <div class="user-block"><img class="img-xs" src="../vendor/dist/img/prod-1.jpg"></div>
                    </th>
                    <td style="text-align:left;">
                      <div class="user-block">
                        <div class="">
                          <a href="/index.php/nvproduit" class="float-left">ProduitProduitProduitProduitProduitProduitProduitProduitProduitProduit 1</a>
                          <div  class="float-left ml-2"><small>(ID : 123456 - SKU : 1597648)</small></div>
                    ...
                    <td class="float-right">
                      ...
                      <div class="dropdown-menu">
                        <a class="dropdown-item" tabindex="-1" href="/index.php/nvproduit">Modifier</a>
