        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <div class="text-right">
              <a href="/index.php/nvcategorie" class="btn btn-outline-dark">Nouvelle Catégorie
              </a>
            </div>
          </div><!-- /.col -->
        </div><!-- /.row -->
                    ...
                    <?php foreach ($cats as $cat) { ?>
                        ...
                        <td style="text-align:left;">
                          <div class="user-block">
                            <span class="">
                              <a href="/index.php/nvcategorie" class="float-left"><?php echo $cat['libele'];?></a>
                            </span>
                          </div>  
                        </td>
                        <td>
                          <span class="badge badge-dark"><?php echo $cat['id_cat'];?></span>
                        </td>
                        <td class="float-right">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" tabindex="-1" href="/index.php/nvcategorie">Modifier</a>
